...
class HighResolutionNet_Classification(nn.Module):
    def __init__(self, num_classes, backbone):
        ...
        #setting different channels for nets
        num_filters = {
...
#mading different layer
    ...
    def forward(self, x):
        ...
        return y
# pretrained:using weight: False or True


#Returnning a net, and choose to load weight of train
